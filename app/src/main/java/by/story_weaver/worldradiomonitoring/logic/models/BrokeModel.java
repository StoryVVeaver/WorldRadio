...
public class BrokeModel implements Serializable {
    ...
    public BrokeModel(String stationUuid, String name, String url, String urlResolved, String homepage,
    ...
    public BrokeModel(String uuid, String name, String url, String favicon, String homepage){
